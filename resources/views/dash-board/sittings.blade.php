...
<form method="POST" action="{{ route('setSittings') }}" class=" m-5  shadow ">
  @csrf
{{-- ارسال الأخطاء --}}
...
<input type="text" id="inputLinkden" class="form-controll"value="@isset($DataSittings){{ $DataSittings->socialMidiaFacebook }} @endisset" >
</div>
