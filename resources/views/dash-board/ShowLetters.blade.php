...
<div class="row">
    <div class="col">
        ...
        <thead class="table ">
            <tr class=" " style="background-color: #2b2d42">
                ...
                <td style="color: #fff">الحرف</td>
                <td style="color: #fff">قيمة الحرف</td>
                <td style="color: #fff"></td>
                <td style="color: #fff;display: flex;
                justify-content: flex-end;border: 0px;"><a href="{{ route('setLetter') }}" style="background-color: #e63946" class="btn add ms-2 mt-2">إضافة حرف</a></td>
    ...
    <tbody class="table-info" >
        ...
        <tr class=" " >
            ...
            <td> {{ $letter->letter }} </td>
            <td>{{ $letter->value }} </td>
            <td ><a   class="update btn " style="background-color: #1d3557" href="{{ route('updateLetter' ,['id'=>$letter->id ]) }}">تعديل</a></td>
            <td ><a   class="delete btn " style="background-color: #e63946" href="{{ route('deleteLetter',['id'=>$letter->id ]) }}">حذف</a></td>
        </tr>
        @endforeach
        @endisset
    </tbody>
                    ...
                    {{-- نهاية عرض الحروف مع التعديل والحذف --}}
