...
@endif
  ...
  <div class="row backgroundW p-4  ">
    ...
    <div class="col-md-12 mb-3">
        ...
        <textarea type="text" id="Description" name="setHead" class="form-controll resizeForTextarea" >@isset($Adds){{ $Adds->atHead }} @endisset</textarea>
        </div>
        <div class="col-md-12 mb-3">
            <label for="Description" class="form-labell ">أعلى محتوى الصفحة</label>
            <textarea type="text" id="Description" name="setTop" class="form-controll resizeForTextarea" >@isset($Adds){{ $Adds->atTop }} @endisset</textarea>
            </div>
            <div class="col-md-12 mb-3">
                <label for="Description" class="form-labell ">منتصف القائمة الجانبية</label>
                <textarea type="text" id="Description" name="setCenter" class="form-controll resizeForTextarea" >@isset($Adds){{ $Adds->atRight }} @endisset</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="Description" class="form-labell">في أسفل الصفحة</label>
                    <textarea type="text" id="Description" name="otherSite" class="form-controll resizeForTextarea" >@isset($Adds){{ $Adds->otherSite }} @endisset</textarea>
                    </div>
      <div class="col-12">
