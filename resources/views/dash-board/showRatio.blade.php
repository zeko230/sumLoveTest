              ...
              <ul class="dropdown-menu  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                ...
                <li>
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                   ...
                   {{-- عرض النسب مع التعديل والحذف --}}
                   <div class="container">
<div class="row">
    <div class="col">
        <table class="table table-hover">
        <thead class="table ">
            <tr class=" " style="background-color: #2b2d42">
                <td style="color: #fff" >id</td>
                <td style="color: #fff">أسم النسبة</td>
                <td style="color: #fff">قيمة الادنى للنسبة</td>
                <td style="color: #fff">قيمة الاعلى للنسبة</td>
                <td style="color: #fff"></td>
                <td style="color: #fff;display: flex;
                justify-content: flex-end;border: 0px;"><a href="{{route('setRatio')}}" style="background-color: #e63946" class="btn add ms-2 mt-2">إضافة نسبة</a></td>
    ...
    <tbody class="table-info" >
        ...
        <tr class=" " >
            <td >{{ $ratio->id }}</td>
            <td> {{ $ratio->nameRatio }} </td>
            <td>{{ $ratio->minValueRatio }} </td>
            <td>{{ $ratio->maxValueRatio }} </td>
            <td ><a   class="update btn " style="background-color: #1d3557" href="{{ route('updateRatio' ,['id'=>$ratio->id ]) }}">تعديل</a></td>
            <td ><a   class="delete btn " style="background-color: #e63946" href="{{ route('deleteRatio',['id'=>$ratio->id ]) }}">حذف</a></td>
        </tr>
        @endforeach
        @endisset
    </tbody>
                    ...
                    {{-- نهاية عرض النسب مع التعديل والحذف --}}
