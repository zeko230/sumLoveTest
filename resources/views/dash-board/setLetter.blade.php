...
<li class="nav-item">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
    ...
    {{-- إدخال الحرف --}}
    <form method="POST" action="{{ route('setLetterIntoDatabase') }}" class=" m-5  shadow ">
        @csrf
      {{-- ارسال الأخطاء --}}
      ...
      @endif
       <input type="hidden" name="id" value="@isset($letter){{ $letter->id }} @endisset">
        <div class="col-12 mb-3">
            <label for="inputFirstNmae" class="form-labell" >الحرف</label>
            <input type="text" maxlength="1" class="@error('nameWebsite') is-invalid @enderror form-controll " name="letter" id="inputFirstNmae" value="@isset($letter){{ $letter->letter }} @endisset" required>
        </div>
       
      
        <div class="col-12 mb-3">
            <label for="inputLastNmae" class="form-labell">قيمة الحرف</label>
            <input type="text" class="form-controll"  name="value" id="inputLastNmae" value="@isset($letter){{ $letter->value }} @endisset" >
        </div>
