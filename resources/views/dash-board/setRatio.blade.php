...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('dashboard/css/sittingsStyle.css')}}" rel="stylesheet" />
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret  bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="me-1 font-weight-bold text-white">Arros Dashboard</span>
      </a>
    </div>
    ...
    <div  dir="rtl" class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{route('createPage')}}">
            ...
            <span class="nav-link-text me-1">انشاء الصفحات الثابتة</span>
        </a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="{{route('showLetters')}}">
          <div class="text-white text-center ms-2 d-flex align-items-center justify-content-center">
              <i class="material-icons-round opacity-10">table_view</i>
          </div>
          <span class="nav-link-text me-1">عرض الحروف</span>
      </a>
  </li>


<li class="nav-item">
    <a class="nav-link " href="{{route('showRatio')}}">
        <div class="text-white text-center ms-2 d-flex align-items-center justify-content-center">
            <i class="material-icons-round opacity-10">table_view</i>
        </div>
        <span class="nav-link-text me-1"> عرض النسب</span>
    </a>
</li>
      </ul>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{ asset('dashboard/img/team-2.jpg') }}" class="avatar avatar-sm  ms-3 ">
                      </div>
    ...
    {{-- إدخال الحرف --}}
    <form method="POST" enctype="multipart/form-data" action="{{ route('setRatioIntoDatabase') }}" class=" m-5  shadow ">
        @csrf
      {{-- ارسال الأخطاء --}}
      ...
      <div class="alert" style="background-color: #42424a ">
        <ul>
            <li  style="color:white" class="">{{ session('message') }}</li>
          </ul>
          </div></div>
      @endif
      ...
      @endif
       <input type="hidden" name="id" value="@isset($ratios){{ $ratios->id }} @endisset">
        <div class="col-12 mb-3">
            <label for="inputNameRatio" class="form-labell" >أسم النسبة</label>
            <input type="text"  class="@error('nameWebsite') is-invalid @enderror form-controll " name="nameRatio" id="inputNameRatio" value="@isset($ratios){{ $ratios->nameRatio }} @endisset" required>
        </div>
       
      
        <div class="col-12 mb-3">
            <label for="minValue" class="form-labell"> الحد الادنى</label>
            <input type="text" class="form-controll"  name="minValue" id="minValue" value="@isset($ratios){{ $ratios->minValueRatio }} @endisset" >
        </div>
        <div class="col-12 mb-3">
            <label for="maxValue" class="form-labell"> الحد الاعلى</label>
            <input type="text" class="form-controll"  name="maxValue" id="maxValue" value="@isset($ratios){{ $ratios->maxValueRatio }} @endisset" >
        </div>
      
        <div class="col-12 mb-3">
          <label for="pictureForShow" class="form-labell labelForPicture"> ادخال صورة</label>
          <input type="file" accept="image/*" class="form-controll   pictureForShow" name="pictureForShow" id="pictureForShow" value="@isset($ratios){{ $ratios->maxValueRatio }} @endisset" >
      </div>
