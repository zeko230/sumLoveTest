            ...
            <form method="POST" action="{{ route('register') }}" class="appointment-form" id="appointment-form">
                ...
                <div class="form-group-1">
                    ...
                    <input type="password" name="password" id="phone_number"
                        class=" @error('password') is-invalid @enderror" name="password" placeholder="password" required
                    ...
                    @enderror
                    <input id="phone_number" type="password" class=" @error('password') is-invalid @enderror"
                ...
                <span class="account">Are you account?</span>
